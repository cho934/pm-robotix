...
namespace utils
{
    ...
    public:
         ...
         *        Message a tracer.
         */
        virtual void writeMessage(const utils::Logger & logger, const utils::Level & level, const std::string & message)=0;
    };
    ...
    public:
        ...
        public:
            ...
            /*!
             * \brief Cet opérateur permet à la méthode utils::end() de remplir
    ...
    public:
         ...
         *        Message a tracer.
         */
        void writeMessage(const utils::Level & level, const std::string & message) const;
         ...
         */
        inline bool isActive(const utils::Level & level) const
        {
            return level >= level_;
        }
         ...
         */
        inline const utils::Level & level() const
        {
            return level_;
        }
         ...
         */
        inline const utils::Appender & appender() const
        {
            return appender_;
        }
     ...
     * notation \code << utils::end; \endcode.
     * \param buffer
     ...
     * \code utils::end(logger.info() << "mon message"); \endcode
     *
