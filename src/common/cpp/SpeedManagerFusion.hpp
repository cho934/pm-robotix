...
namespace pmx
{
    ...
    private:
        ...
        /*!
         * \brief Nombre de tick codeur moteur mécanisme Red.
         */
        long nbTickRed_;
        ...
        /*!
         * \brief Paramètre d'activation de la partie de code concernant
         * l'asservissement des moteurs de propulsion.
         */
        bool ActiveSMF_;

        /*!
         * \brief Paramètre d'activation de la partie de code concernant
         * l'asservissement des moteurs mécanismes (RED/YELLOW).
         */
        bool SMFMotorRedYellowEnabled_;
        ...
        int distanceTotalLeft_; //distance linéaire parcourue par la roue depuis le début de l'execution du OnTimer en tick.
        int distanceTotalRight_; //distance linéaire parcourue par la roue droite depuis le début de l'execution du OnTimer en tick.
    ...
    public:
         ...
         * \param pidL et pidR et pidMotorRed et pidMotoryellow
         *        PID exploité pour les corrections de la vitesse moteur gauche et droit.
         */
        SpeedManagerFusion(pmx::Base * base, 
    ...
    public:
        ...
        virtual void onRightPulse(int motorEncoderValue, int motorBEncorderValue, utils::Chronometer)
        {
            nbPulsesRight_ += motorEncoderValue;
            nbTickRed_ += motorBEncorderValue;
        }
        ...
        virtual void activateSMFMotorRedYellow(bool enable)
        {
            SMFMotorRedYellowEnabled_ = enable;
        }
        ...
        virtual void reset()
        {
            ...
            this->distanceTotalLeft_ = 0;
            this->distanceTotalRight_ = 0;
