/*!
 * \file
 * \brief Définition de la classe PID.
 */
...
namespace utils
{
    ...
    public:
        ...
        /*!
         * \brief Calcul le PID avec paramètre D filtré.
         */
        double ComputePIFilterD(int error, int realval);

        /*!
         * \brief Reset le PID pour reprendre un nouveau calcul.
         */
        void reset();
    };
}
