/*!
 * \file
 * \brief Définition de la classe Configuration.
 */
...
utils::Configuration::getString(const std::string & property)
{
    ...
    {
        logger().error() << "The property <"+ property +"> doesn't exist" << utils::end;
...
utils::Configuration::getDouble(const std::string & property)
{
    ...
    {
        logger().error() << "The property <"+ property +"> is not a double" << utils::end;
...
utils::Configuration::getInt(const std::string & property)
{
    ...
    {
        logger().error() << "The property <"+ property +"> is not a int" << utils::end;
