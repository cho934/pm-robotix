...
utils::LoggerFactory::initialize()
{
    ...
    //add("console", new MemoryAppender());
    ...
    //add("odometry-csv", new SvgAppender ("odo.csv")); //(FileAppender ou SvgAppender ?)
    ...
    add(utils::Level::INFO, "test::ClampTest", "console");
    add(utils::Level::INFO, "test::RobotMoveToPawnTest", "console");
    add(utils::Level::DEBUG, "test::RobotOpponentTest", "console");
