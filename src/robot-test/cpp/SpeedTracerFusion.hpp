...
namespace test
{
     ...
     */
    class SpeedTracerFusion : public pmx::IMotorListener, utils::ITimerListener
    {
    private:
        /*!
         ...
         */
        static const int PERIOD_TIMER = 150;
    ...
    private:
         ...
         */
        double averageSpeedLeft_[1024];
        double averageSpeedRight_[1024];

        /*!
         * \brief Le nombre de vitesses enregistrées pour un motorCode pour le calcul de la moyenne.
         */
        ushort numberSpeedLeft_[1024];
        ushort numberSpeedRight_[1024];
    ...
    public:
        ...
        inline void onLeftPulse(int value, utils::Chronometer, pmx::MotorWay)
        {
            nbPulsesLeft_+=value;
        }
        
        inline void onRightPulse(int value, utils::Chronometer, pmx::MotorWay)
        {
