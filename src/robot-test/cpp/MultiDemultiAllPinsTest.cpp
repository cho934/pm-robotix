/*!
 * \file
 * \brief Implémentation de la classe TestM2, test des multiplexeurs avec les demultiplexeurs.
 * \todo Supprimer cette classe ? elle regroupe un test unitaire (RobotIn RobotOut) et un test du robot (pin).
 */
...
{
    std::cout << "Nécessite de brancher le DM avec le M correspondant." << std::endl;
