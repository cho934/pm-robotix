...
std::string test::ApfInModeTest::INPUT_PORT_PATH_DEV = "/dev/gpio/P"; // écriture (write) et lecture (read) blocante sur pin
std::string test::ApfInModeTest::INPUT_PORT_PATH_PROC = "/proc/driver/gpio/port"; //lecture port/dir/irq : cat /proc/driver/gpio/portD

void test::ApfInModeTest::run(int argc, char *argv[])
{
 ...
 *
 */
void test::ApfInModeTest::in_V4_ioctl_for_port(std::string, std::string)
{
...
void test::ApfInModeTest::in_V3_ioctl_for_pin(std::string inGpioPort, std::string inPin)
{
 ...
 * 
 */
void test::ApfInModeTest::in_V2_blockingread(std::string inGpioPort, std::string inPin)
{
 ...
 * 
 */
void test::ApfInModeTest::in_V1_blockingReadFstream(std::string inGpioPort, std::string inPin)
{
