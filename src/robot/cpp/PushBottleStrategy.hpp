/*!
 * \file
 * \brief Définition de la classe PushBottleStrategy.
 */

#ifndef PMX_PUSHBOTTLESTRATEGY_HPP
#define PMX_PUSHBOTTLESTRATEGY_HPP
...
namespace pmx
{
     ...
     */
    class PushBottleStrategy : public AStrategy
    {
    private:

        static inline const utils::Logger & logger()
        {
            static const utils::Logger & instance = utils::LoggerFactory::logger("pmx::PushBottleStrategy");
            return instance;
        }
    public:
         ...
         */
        PushBottleStrategy(StateDecisionMaker* decisionMaker)
        {
            this->addState("decisionMaker", decisionMaker);
        }
          virtual std::string name()
        {
            return "PushBottleStrategy";
        }
        /*!
         * \brief Destructeur de la classe.
         */
        virtual ~PushBottleStrategy()
        {
        }
