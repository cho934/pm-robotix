...
namespace test
{
    ...
    private:
        ...
        void TSC3414All(struct as_i2c_device *aDev, uint8_t allcolors[]);
        uint8_t TSC3414Red(struct as_i2c_device *aDev);
        uint8_t TSC3414Green(struct as_i2c_device *aDev);
        uint8_t TSC3414Blue(struct as_i2c_device *aDev);
        uint8_t TSC3414Clear(struct as_i2c_device *aDev);
