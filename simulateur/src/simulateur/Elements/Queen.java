...
/**
 * Queen is composed on a pawn topped by an other cylinder (Pawn)
 * BASE
 * Height : 50 mm
 * Diameter : 200 mm
...
public class Queen extends GameElement {
	...
	/**
	 * CONSTRUCTOR [QUEEN] Create a new QUEEN, position it at it's initial place.
	 * @param x initial X position of the Queen
	 * @param y initial Y position of the Queen
	 */
	public Queen(int x, int y, ElementsManager e) {
		super(x,y,e);
		type = "QUEEN" ;
	}
	...
	public void drawElement(Graphics g) {
		...
		g.setColor(Constants.COL_ELEMENT_QUEEN) ;
