...
namespace pmx
{
    //class SpeedManagerFusion; //plus necessaire ?
    ...
    public:
        ...
        /*!
         * \brief Modificateur pour l'ordre de vitesse associé au robot et du sens de marche en conséquence (deprecated).
         *
         * \param orderSpeed
        ...
        /*!
         * \brief Convertie un code moteur en la vitesse équivalente (en mm/s). (deprecated).
        ...
        /*!
         * \brief Convertie une vitesse dans le code moteur associé (deprecated).
