...
namespace pmx
{
    ...
    private:
        ...
        /*!
         * \brief Mode de match (coupe ou homologation).
         */
         ...
         * \brief Capteur bas droit pour détecter les pions.
         */
        pmx::IrSensor opponentIrSensor_;
    ...
    public:
        ...
        /*!
         * \brief Retourne le mode ZAP de match du robot.
         */
        inline int modeZap() const
        {
            return modeZap_;
        }

        /*!
         * \brief Enregistre le mode ZAP de match du robot.
         */
        inline void modeZap(int mode)
        {
            this->modeZap_ = mode;
        }
        ...
        inline pmx::IrSensor & opponentIrSensor()
        {
            return opponentIrSensor_;
        }
        ...
        {
            logger().debug() << "IMotorListener addListener" << utils::end;
