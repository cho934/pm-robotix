/*!
 * \file
 * \brief Implémentation de la classe ClampAdjustmentTest.
 */

#include "ClampAdjustmentTest.hpp"
#include "Robot.hpp"
...
void test::ClampAdjustmentTest::run(int argc, char *argv[])
{
    std::cout << "test::ClampAdjustmentTest: Start" << std::endl;
