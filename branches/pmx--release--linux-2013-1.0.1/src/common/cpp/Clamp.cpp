...
pmx::Clamp::Clamp(pmx::Robot & robot, int positionIndex1, int positionIndex2)
: ARobotElement(robot), positionIndex1_(positionIndex1), positionIndex2_(positionIndex2),
        stateOpened_(0), actionStopped_(0)
{}
