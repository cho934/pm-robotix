...
void pmx::RobotInOutParallelPort::setValues(ushort demultiplexor, ushort value)
{
    this->lock();
...
bool pmx::RobotInOutParallelPort::getValue(ushort multiplexor, ushort pin)
{
    this->lock();
    ...
    //TODO : cho : temps minimum afin de prendre en compte la valeur => A calculer et voir si trop long! 
...
//TODO optimiser la recupération getImpLeft et getImpLeftWay d'un seul coup
