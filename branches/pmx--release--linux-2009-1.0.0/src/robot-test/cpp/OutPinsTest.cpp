/*!
 * \file
 * \brief Implémentation de la classe UnitTestTestDM, teste des démultiplexeurs.
 */
...
void test::OutPinsTest::drawLine(int dm, int nPin, bool state)
{
    std::cout << "dm" << dm << " ";
...
void test::OutPinsTest::run(int, char *[])
{
    std::cout << "Pour chaque DM, applique un 1 puis un 0 à chaque pin par ordre croissant puis décroissant." << std::endl;
    std::cout << std::endl;
