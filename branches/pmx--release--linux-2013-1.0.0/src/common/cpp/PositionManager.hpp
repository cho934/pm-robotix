...
namespace pmx
{
    ...
    public:
         ...
         *
         */
        static const double DISTANCE_ENTRAXE_MOTORWHEEL = 237.0;

        /*!
         * \brief Distance de l'entraxe entre les 2 roues libres (en mm).
         *
         */
        static const double DISTANCE_ENTRAXE_FREEWHEEL = 0.0;//\TODO
         ...
         * 
         */
        static const double DISTANCE_PER_FREE_PULSE = 0.0; //\TODO
         ...
         */
        static const double ANGLE_PER_MOTOR_PULSE = 0.0036451476793249;
        ...
        static const double ANGLE_PER_FREE_PULSE = 0.0; //0.003916998474 //\TODO
