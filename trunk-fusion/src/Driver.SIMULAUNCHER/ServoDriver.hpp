#ifndef SIMULAUNCHER_SERVODRIVER_HPP_
#define SIMULAUNCHER_SERVODRIVER_HPP_
...
private:
	...
	/*!
	 * \brief Retourne le \ref Logger associé à la classe \ref ServoDriver(SIMULAUNCHER).
	 */
	static inline const logs::Logger & logger()
	{
		static const logs::Logger & instance = logs::LoggerFactory::logger("ServoDriver.SIMULAUNCHER");
		return instance;
	}
